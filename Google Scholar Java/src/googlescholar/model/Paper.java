...
public class Paper {
  ...
  public void cg_init_Paper_2(
      final String ab, final Number pubDate, final String doi, final VDMSet authrs) {
  ...
  public void cg_init_Paper_1(
      final String ab, final Number pubDate, final String doi, final String author) {
  ...
  public Paper(final String ab, final Number pubDate, final String doi, final String author) {

    cg_init_Paper_1(ab, pubDate, doi, author);
  }

  public Paper(final String ab, final Number pubDate, final String doi, final VDMSet authrs) {

    cg_init_Paper_2(ab, pubDate, doi, Utils.copy(authrs));
  }
